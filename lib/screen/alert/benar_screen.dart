...
class BenarScreen extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: TextStyle(color: Colors.white, fontSize: 80, fontWeight: FontWeight.bold, fontFamily: 'Larken DEMO'),
              textAlign: TextAlign.center,
            ),
            SizedBox(height: 20),
            Text(
              'kamu berhasil menebak semua tebakan',
